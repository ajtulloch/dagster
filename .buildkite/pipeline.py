...
IMAGE_MAP = {
    SupportedPython.V3_7: "dagster/buildkite-python:3.7",
    SupportedPython.V3_6: "dagster/buildkite-python:3.6",
    SupportedPython.V3_5: "dagster/buildkite-python:3.5",
    SupportedPython.V2_7: "dagster/buildkite-python:2.7",
}
