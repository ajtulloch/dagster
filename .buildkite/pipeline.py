...
IMAGE_MAP = {
    SupportedPython.V3_7: "python:3.7.3-alpine",
    SupportedPython.V3_6: "python:3.6.8-alpine",
    SupportedPython.V3_5: "python:3.5.7-alpine",
    SupportedPython.V2_7: "python:2.7.16-alpine",
}
...
if __name__ == "__main__":
    steps = [
        ...
        .on_docker_image("alexlangenfeld/buildkite-pynode")
        .build(),
    ]
